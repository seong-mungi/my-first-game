...
| Design docs Designed (pending re-review after Round 1 BLOCKING applied) | 0 (System #1 Input reverted to In Design 2026-05-11 — fresh-session `/design-review` returned MAJOR REVISION NEEDED with 22 BLOCKING; see [reviews/input-review-log.md](reviews/input-review-log.md). System #6 Player Movement also In Design with 10 BLOCKING — see [reviews/player-movement-review-log.md](reviews/player-movement-review-log.md). Both systems queued for solo revision sessions.) |

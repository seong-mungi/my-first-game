...
> **Status**: Draft (v0)
> **Created**: 2026-05-09
> **Last Updated**: 2026-05-09 (System #8 Damage / Hit Detection — **Round 4 LOCKED for prototype**, 3 surgical fixes 적용 (BLOCK-R4-1 AC-21 regex broadening, BLOCK-R4-2 AC-29 hardcoded fixture baseline, B-R4-1 systems-designer post-lock DEC-6 hazard grace off-by-one — `_hazard_grace_remaining = hazard_grace_frames + 1` 보상). creative-director verdict: LOCK & PROTOTYPE — Round 5 차단. Round 3: 4 BLOCKING 적용. Round 2: 8 BLOCKING + 12 RECOMMENDED 적용. ADR 3건 queued.)
...
| 5 | **State Machine Framework** | Core | MVP | **Designed** (Lean review skipped — fresh-session `/design-review` 권장) | [state-machine.md](state-machine.md) | — (Foundation; 시그널 소비자: Damage #8, Time Rewind #9, Scene #2, Input #1) |
| 6 | Player Movement | Gameplay | MVP | Not Started | — | Input, State Machine, Scene |
| 7 | Player Shooting / Weapon System | Gameplay | MVP | Not Started | — | Input, Player Movement, Damage |
| 8 | Damage / Hit Detection | Gameplay | MVP | **LOCKED for prototype (Round 4 reviewed 2026-05-09)** — Round 2: 7-specialist + creative-director, MAJOR REVISION 8/12 적용. Round 3: 4-specialist + creative-director, NEEDS REVISION 4 BLOCKING 적용. Round 4: qa-lead + creative-director synthesis, LOCK & PROTOTYPE 2 surgical AC fixes (AC-21 regex broadening, AC-29 hardcoded fixture baseline). Round 5 차단 (post-lock observations only). ADR 3건 queued (boss-phase-advance-monotonicity, signal-emit-order-determinism, ADR-0003 priority 사다리 갱신). | [damage.md](damage.md) | State Machine #5, Time Rewind #9, Player Movement #6, Player Shooting #7, Enemy AI #10, Boss Pattern #11, Stage #12 |
| 9 | **Time Rewind System** ⚠️ | Gameplay | MVP | **Designed** (Lean review skipped — re-review on `--review full` 또는 fresh-session `/design-review`) | [time-rewind.md](time-rewind.md) | Input, Scene Manager, State Machine, Player Movement, Damage |
...
| Design docs Designed (pending review) | 3 (System #9 Time Rewind, System #5 State Machine Framework, System #8 Damage / Hit Detection) |

...
| Design docs approved (re-review 통과 or LOCKED for prototype) | 4 (System #1 Input — re-review APPROVED 2026-05-11 lean mode, all 22 prior BLOCKING resolved; System #5 State Machine — Round 2 + Round 5 W4 fix; System #8 Damage — Round 4 LOCKED + Round 5 cross-doc S1 fix; System #9 Time Rewind — Round 2 + Round 5 Rule 17 split. All verifier-confirmed PASS.) |
| Design docs Designed (pending re-review after Round 1 BLOCKING applied) | 0 (System #6 Player Movement In Design with 10 BLOCKING — see [reviews/player-movement-review-log.md](reviews/player-movement-review-log.md). System #1 Input promoted to Approved 2026-05-11 after lean re-review confirmed all 22 BLOCKING resolved.) |
